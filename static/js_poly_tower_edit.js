...
function initialize() {
    ...
    var lat_exis = document.getElementById("lat").value;
    var lng_exis = document.getElementById("lng").value;
  ...
  var myOptions = {
    zoom: 16,
    center: new google.maps.LatLng(lat_exis,lng_exis),
  ...
  marker = new google.maps.Marker({
      position: new google.maps.LatLng(lat_exis,lng_exis),
      map: map,
      draggable:true,
...
function close_tap(id){
    var ele = document.getElementById(id);
    ele.style.display = "none";
}

function open_tap(id){
    var ele = document.getElementById(id);
    ele.style.display = "block";
}

function open_page_tap(id){
    $('#tap1').css('background','#333');
    $('#tap2').css('background','#333');
    $('#tap3').css('background','#333');
    $('#tap4').css('background','#333');
